...
public class TradeInfo
{
    ...
    {
        PacketTradeReadyInfo info = new PacketTradeReadyInfo(trader1.getName(), ready1, trader2.getName(), ready2);
        Hats.channel.sendTo(info, trader1);
        Hats.channel.sendTo(info, trader2);
    }
    ...
    public void receiveTradeInfo(TreeMap<String, Integer> hats, ArrayList<ItemStack> items, EntityPlayerMP player)
    {
        ...
        {
            sendTradeMessage(I18n.translateToLocal("hats.trade.you") + " " + I18n.translateToLocal("hats.trade.removed") + " " + TextFormatting.WHITE + e.getKey(), player1);
            sendTradeMessage(player1.getName() + " " + I18n.translateToLocal("hats.trade.removed") + " " + TextFormatting.WHITE + e.getKey(), player2);
        }
        for(ItemStack is : oldItems)
        {
        ...
        {
            sendTradeMessage(I18n.translateToLocal("hats.trade.you") + " " + I18n.translateToLocal("hats.trade.added") + " " + TextFormatting.WHITE + e.getKey(), player1);
            sendTradeMessage(player1.getName() + " " + I18n.translateToLocal("hats.trade.added") + " " + TextFormatting.WHITE + e.getKey(), player2);
        }
    ...
    public void toggleReadyTrader1(boolean shouldReady)
    {
        if(!shouldReady && ready1)
        {
            ...
            sendTradeMessage(I18n.translateToLocalFormatted("hats.trade.notReadyThem", trader1.getName()));
            ready1 = false;
            trade1 = trade2 = false;
            sendReadyInfo();
        }
        else if(shouldReady && !ready1)
        {
            ...
            sendTradeMessage(I18n.translateToLocalFormatted("hats.trade.readyThem", trader1.getName()));
            ready1 = true;
            sendReadyInfo();
        }
    }
